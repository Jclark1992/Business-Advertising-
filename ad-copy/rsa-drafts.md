# Responsive Search Ad Drafts — Laser Hair Removal Only

Scope: laser hair removal only — no IPL/facials copy belongs here. Draft
copy per ad group, matching `keyword-research/keyword-list.md`. Items
...
- Don't publish "certified," "#1 in Edmonton," years-in-business, or
  specific session-count/results claims until confirmed — unverified
  claims risk ad disapproval and credibility.
- Once live, prioritize copy that reflects what's actually converting
  (see `reports/optimization-framework.md`) over further guessing.
